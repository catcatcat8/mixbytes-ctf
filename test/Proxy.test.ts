...
import { Buckets, BucketsProxy, Buckets__factory } from '../typechain'
...
async function setup() {
  await deployments.fixture(['Buckets', 'BucketsProxy'])
...
describe('Example unit test', () => {
  ...
  describe('Constructor', () => {
    it('Hack', async () => {
      const { buckets, proxy, deployer, backend, feeAddress, users } = await setup()
